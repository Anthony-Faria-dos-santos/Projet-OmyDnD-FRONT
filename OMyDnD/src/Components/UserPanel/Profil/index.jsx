          ...
          <form onSubmit={handleSubmit} className="flex items-center justify-around">
            <div className="bg-gray-700 rounded-lg p-3 m-4 h-fit">
              ...
              <div className="bg-gray-800 p-2 m-2 rounded-lg">
                ...
                /></div>
              <div className="flex justify-between bg-gray-800 p-2 m-2 rounded-lg"><label htmlFor="pseudo" className="text-gray-50">Modifier le pseudo actuel <strong>({user.pseudo})</strong> :</label>
                <input
                  type="text"
                  id="pseudo"
                  name="pseudo"
              ...
              <div className="flex justify-between bg-gray-800 p-2 m-2 rounded-lg"><label htmlFor="oldPassword" className="text-gray-50">Mot de passe actuel :</label>
                <input
                  type="password"
                  id="oldPassword"
                  name="oldPassword"
              ...
              <div className="flex justify-between bg-gray-800 p-2 m-2 rounded-lg"><label htmlFor="password" className="text-gray-50">Mot de passe :</label>
                <input
                  type="password"
                  id="password"
                  name="password"
              ...
              <div className="flex justify-between bg-gray-800 p-2 m-2 rounded-lg"><label htmlFor="confirmPassword" className="text-gray-50">Confirmation du mot de passe :</label>
                <input
                  type="password"
                  id="confirmPassword"
