                      ...
                      <div className="mt-1">
                        <div className="flex rounded-md bg-orange-600 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-500">
                          <input
                            ...
                            readOnly
                            className="w-full text-center flex-1 border-0 bg-transparent py-1.5 pl-1 text-white focus:ring-0 sm:text-sm sm:leading-6"
                            value={caractBonusCalculator(character?.constitution)}
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="mt-1">
                        <div className="flex rounded-md bg-orange-600 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-500">
                          <input
                            ...
                            readOnly
                            className="w-full text-center flex-1 border-0 bg-transparent py-1.5 pl-1 text-white focus:ring-0 sm:text-sm sm:leading-6"
                            value={caractBonusCalculator(character?.inteligence)}
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="mt-1">
                        <div className="flex rounded-md bg-orange-600 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-500">
                          <input
                            ...
                            readOnly
                            className="w-full text-center flex-1 border-0 bg-transparent py-1.5 pl-1 text-white focus:ring-0 sm:text-sm sm:leading-6"
                            value={caractBonusCalculator(character?.wisdom)}
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="mt-1">
                        <div className="flex rounded-md bg-orange-600 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-500">
                          <input
                            ...
                            readOnly
                            className="w-full text-center flex-1 border-0 bg-transparent py-1.5 pl-1 text-white focus:ring-0 sm:text-sm sm:leading-6"
                            value={caractBonusCalculator(character?.charisma)}
                          />
                        </div>
                      </div>
                    </div>
